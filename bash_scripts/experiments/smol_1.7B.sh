...
NODES=(3 8)  # List of node numbers
MASTER_NODE=3  # Specify which node number is the master
SYNC_MASTER=false  # Flag to determine whether to sync and check on the master node
RUN_NAME="Smollm_1B"  # Specify a unique name for this run
NNODES=${#NODES[@]}
GRAD_ACCUMULATION=$((36 / NNODES))
CONFIG_FILE=/work/benyamin/smollm/pre-training/smollm2/config_smollm2_1B.yaml
